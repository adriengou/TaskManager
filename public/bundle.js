...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"browser-app.js":[function(require,module,exports) {
"use strict";
...
var showTasks = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _yield$get, tasks, allTasks;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.get)("/api/v1/tasks");

          case 4:
            _yield$get = _context.sent;
            tasks = _yield$get.data.tasks;
...
tasksDOM.addEventListener("click", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 5;
            _context2.next = 8;
            return _axios.default.delete("/api/v1/tasks/".concat(id));
...
formDOM.addEventListener("submit", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 2;
            _context3.next = 5;
            return (0, _axios.post)("/api/v1/tasks", {
              name: name
            });
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","browser-app.js"], null)
